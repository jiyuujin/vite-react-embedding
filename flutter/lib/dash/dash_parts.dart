...
class DashParts {
  ...
  static Path get _dashFace {
    return Path()
      ..addOval(
        Rect.fromPoints(
          const Offset(106.5, 123.0),
          const Offset(455.0 + 106.5, 435 + 123.0),
        ),
      )
      ..addOval(
        Rect.fromPoints(
          const Offset(408.5, 123.0),
          const Offset(408.5 + 455.0, 123.0 + 435.0),
        ),
      );
  }
  ...
  static Path get _dashEyeSocketsContours {
    return Path()
      ..addOval(
        Rect.fromPoints(
          const Offset(230.0, 215.0),
          const Offset(230.0 + 155.0, 215.0 + 170.0),
        ),
      )
      ..addOval(
        Rect.fromPoints(
          const Offset(585.0, 215.0),
          const Offset(585.0 + 155.0, 215.0 + 170.0),
        ),
      );
  }
  ...
  static Path get _dashEyeSockets {
    return Path()
      ..addOval(
        Rect.fromPoints(
          const Offset(240.0, 225.0),
          const Offset(240.0 + 135.0, 225.0 + 150.0),
        ),
      )
      ..addOval(
        Rect.fromPoints(
          const Offset(595.0, 225.0),
          const Offset(595.0 + 135.0, 225.0 + 150.0),
        ),
      );
  }
  ...
  static Path get _dashEyes {
    return Path()
      ..addOval(
        Rect.fromPoints(
          const Offset(282.5, 275.0),
          const Offset(282.5 + 50.0, 275.0 + 50.0),
        ),
      )
      ..addOval(
        Rect.fromPoints(
          const Offset(637.5, 275.0),
          const Offset(637.5 + 50.0, 275.0 + 50.0),
        ),
      );
  }
  ...
  static Path getSparkle(Offset at, double rotatedWith) {
    ...
    return dashEyeSparkle.transform(Float64List.fromList(l as dynamic));
  }

  static Path get _dashBelly {
    Offset topLeft = const Offset(160, 500);
    Offset topRight = const Offset(810, 500);
  ...
  static Path get _dashRightWing {
    Matrix4 m = Matrix4.identity()
      ...
      ..setRotationZ(-pi / 10);
    List l = m.storage.toList();
    return dashWing.transform(Float64List.fromList(l as dynamic));
  }
    ...
    return Path()
      ..addOval(
        Rect.fromPoints(
          ...
          const Offset(50.0, 95.0),
        ),
      )
      ..addOval(
        Rect.fromPoints(
          const Offset(33.0, 0.0),
          const Offset(33.0 + 50.0, 95.0),
        ),
      )
      ..addOval(
        Rect.fromPoints(
          const Offset(66.0, 0.0),
          const Offset(66.0 + 50.0, 95.0),
        ),
      );
  }
  ...
  static Path get _dashRightLeg {
    ...
    List l = m.storage.toList();
    return dashLeg.transform(Float64List.fromList(l as dynamic));
  }
  ...
  static Path get _dashNose {
    ...
    List l = m.storage.toList();
    return dashNoseBase.transform(Float64List.fromList(l as dynamic));
  }
